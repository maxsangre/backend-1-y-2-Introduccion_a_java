 ...
 */
public class entiJuego02 {
     private ArrayList<entiJugador02> jugadoresList;
    private entiRevolver02 revolver;

    public entiJuego02() {
    }

    public entiJuego02(ArrayList<entiJugador02> entiJuego02ArrayList, entiRevolver02 revolverObj) {
        this.jugadoresList =entiJuego02ArrayList;
        this.revolver = revolverObj;
    }

    public ArrayList<entiJugador02> getJugadorArrayList() {
        return jugadoresList;
    }

    public void setJugadorArrayList(ArrayList<entiJugador02> jugadorArrayList) {
        this.jugadoresList = jugadorArrayList;
    }

    public entiRevolver02 getRevolverObj() {
        return revolver;
    }

    public void setRevolverObj(entiRevolver02 revolverObj) {
        this.revolver = revolverObj;
    }
