...
del tambor que se dispara, puede que esté el agua o no) y 
* posición agua (la posición del
...
• mojar(): devuelve true si la posición del agua coincide con
* la posición actual
• siguienteChorro(): cambia a la siguiente posición del tambor
• toString(): muestra información del revolver (posición 
* actual y donde está el agua)
 ...
 */
public class entiRevolver02 {
      private int posActual;
    private int posAgua;

    public entiRevolver02() {
    }

    public entiRevolver02(int posActual, int posAgua) {
