...
* descuento para los mismos* tratamientos que los socios del tipo A.Los socios que menos aportan, 
* los de tipo ‘C’, no reciben descuentos sobre dichos tratamientos.Solicite una letra (carácter) que
* representa la clase de un socio, y luego un valor real que represente el costo del tratamiento 
