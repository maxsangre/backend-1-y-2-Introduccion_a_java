 ...
 */
    ...
    public class entiHotel5EstrellasEx03 extends entiHotel4EstrellasEx03 {
    ...
    public entiHotel5EstrellasEx03() {
    }

    public entiHotel5EstrellasEx03(String tipoGimnasio, String nombreRestaurante, int capacidadRestaurante, int cantidadSalonesConferencia, int cantidadSuites, int cantidadLimosinas) {
    ...
    public entiHotel5EstrellasEx03(String nombre, String direccion, String localidad, String gerente, int cantidadHabitaciones, int numeroCamas, int cantidadPisos, double precioHabitaciones, String tipoGimnasio, String nombreRestaurante, int capacidadRestaurante, int cantidadSalonesConferencia, int cantidadSuites, int cantidadLimosinas) {
    ...
    public entiHotel5EstrellasEx03 crearHotelCincoEstrellas() {
