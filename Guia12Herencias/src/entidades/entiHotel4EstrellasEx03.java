 ...
 */
    ...
    public class entiHotel4EstrellasEx03 extends entiHotelEx03 {
    ...
    public entiHotel4EstrellasEx03() {
    }

    public entiHotel4EstrellasEx03(String tipoGimnasio, String nombreRestaurante, int capacidadRestaurante) {
        this.tipoGimnasio = tipoGimnasio;
        this.nombreRestaurante = nombreRestaurante;
        this.capacidadRestaurante = capacidadRestaurante;
    }

    public entiHotel4EstrellasEx03(String nombre, String direccion, String localidad, String gerente, int cantidadHabitaciones, int numeroCamas, int cantidadPisos, double precioHabitaciones, String tipoGimnasio, String nombreRestaurante, int capacidadRestaurante) {
    ...
    public entiHotel4EstrellasEx03 crearHotelCuatroEstrellas() {
