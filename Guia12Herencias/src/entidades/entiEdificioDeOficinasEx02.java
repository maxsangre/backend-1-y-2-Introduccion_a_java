...
dos polideportivos y dos edificios de oficinas. Luego, recorrer
* este array y ejecutar los
 ...
 */
    ...
    public class entiEdificioDeOficinasEx02 extends entiEdificioEx02 {

    private int numOficinas;
    private int cantPersonasOficina;
    private int numPisos;

    public entiEdificioDeOficinasEx02() {
    }

    public entiEdificioDeOficinasEx02(double ancho, double alto, double largo, int numOficinas, int cantPersonasOficina, int numPisos) {
