 ...
 */
   ...
   public class barcoMotorEx01 extends BarcoEx01 {
    protected int potenciaCV;

    public barcoMotorEx01() {
    }

    public barcoMotorEx01(String matricula, double eslora, int anioFabricacion, int potenciaCV) {
