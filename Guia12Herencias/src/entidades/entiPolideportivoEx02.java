 ...
 */
    ...
    public class entiPolideportivoEx02 extends entiEdificioEx02 {
    private boolean techado;


    public entiPolideportivoEx02() {

    }

    public entiPolideportivoEx02(double ancho, double alto, double largo, boolean techado) {
