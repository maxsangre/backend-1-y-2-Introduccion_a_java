...
* Electrodomésticos
para guardar 4 electrodomésticos, ya sean lavadoras o televisores, con valores 
* ya asignados.
Luego, recorrer este array y ejecutar el método precioFinal() en cada
* electrodoméstico. Se
deberá también mostrar el precio de cada tipo de objeto, es decir, el precio de
* todos los
televisores y el de las lavadoras. Una vez hecho eso, también deberemos mostrar,
* la suma del
...
electrodomésticos, 2000 para lavadora y 5000 para televisor.
    ...
    public static void main(String[] args) {
        //Parte Ejerc 02
          entiLavadora02 lavadoraObj = new entiLavadora02();
      lavadoraObj.crearLavadora();
      System.out.println(lavadoraObj);
       entiTelevisor02 televisorObj = new entiTelevisor02();
