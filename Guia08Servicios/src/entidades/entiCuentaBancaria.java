...
cuenta.
 */
public class entiCuentaBancaria {
    ...
    public entiCuentaBancaria() {
    }

    public entiCuentaBancaria( int numeroCuenta, long dniCliente, float saldoActual) {
