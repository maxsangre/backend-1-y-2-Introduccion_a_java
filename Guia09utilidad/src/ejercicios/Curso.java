...
public class Curso {
     ...
     * turno (mañana o tarde),  precioPorHora y alumnos. Donde alumnos es
     * un arreglo de tipo String de dimensión 5 (cinco), donde se alojarán los 
...
* multiplicar la cantidad de horas por día, el precio por hora, la cantidad 
* de alumnos y la cantidad de días a la semana que se repite el encuentro.
    ...
    public static void main(String[] args) {
        ...
        servCurso service = new servCurso();
        entiCurso grupo1 = service.crearCurso();
