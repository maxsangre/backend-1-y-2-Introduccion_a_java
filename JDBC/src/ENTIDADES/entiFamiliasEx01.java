...
public class entiFamiliasEx01 {
    ...
    public entiFamiliasEx01() {
    }
    
    public entiFamiliasEx01(int Id_familia){
        this.Id_familia = Id_familia;
    }

    public entiFamiliasEx01(String nombre, int edad_minima, int edad_maxima, int num_hijos, String email, int id_casa_familia) {
        this.nombre = nombre;
