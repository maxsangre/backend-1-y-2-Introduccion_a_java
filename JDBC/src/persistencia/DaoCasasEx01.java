 ...
 * @author Sangre
 */
public class DaoCasasEx01 extends DAO {
     ...
     */
    public ArrayList<entiCasaEx01> listarCasas(String opc) throws Exception {
        ...
        ArrayList<entiCasaEx01> listarCasas = new ArrayList();
        entiCasaEx01 c;
        try {
            if ("g".equals(opc)) {
